...
const MaintenanceScreen = () => {
    return (
        <div className="fixed inset-0 z-[9999] bg-slate-900/80 backdrop-blur-sm flex flex-col items-center justify-center p-6 text-center animate-in fade-in duration-300">
            <div className="bg-white p-8 rounded-3xl shadow-xl max-w-md w-full border border-gray-100 flex flex-col items-center animate-in fade-in zoom-in duration-500">
                ...
                <p className="text-gray-500 text-sm mb-6 leading-relaxed">
                    We're currently performing scheduled maintenance to improve your experience. Access is temporarily restricted.
                </p>
                ...
                <div className="bg-blue-50 p-4 rounded-xl flex items-start gap-3 text-left w-full mb-6">
                    ...
                    <div>
                        <p className="text-xs font-bold text-blue-800">Note for Administrators</p>
                        <p className="text-[11px] text-blue-600 mt-0.5">
                            Admins can still log in to manage system settings.
                        </p>
                    </div>
                </div>
            ...
            <p className="mt-8 text-xs text-gray-400 font-mono">InsightEd System v1.0</p>
        </div>
    );
};
